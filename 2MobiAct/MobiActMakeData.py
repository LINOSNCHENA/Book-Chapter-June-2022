...
df3 = pd.read_csv('./../5dataXYZ/XMobiAct1.csv', header=0, delimiter=',')  # 32-Years
df3.to_csv(r'./../5dataXYZ/XMobiAct2.csv', index=0)
print(df3.shape)

df4 = pd.DataFrame(df2)
df4.to_csv(r'./../5dataXYZ/XMobiAct3.csv', index=0)
df4 = pd.read_csv('./../5dataXYZ/XMobiAct3.csv', header=0, delimiter=',')  # 32-Years
...
df5 = pd.read_csv('./../5dataXYZ/XMobiAct5.csv', header=0, delimiter=',')  # 32-Years
df5.to_csv(r'./../5dataXYZ/XMobiAct6.csv', index=0)
print(df5.shape)

df6 = pd.read_csv('./../5dataXYZ/XMobiAct6.csv', header=1, delimiter=',')  # 32-Years
