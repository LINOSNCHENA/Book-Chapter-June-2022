...
# save model to file
pickle.dump(model, open("modelMobileAct.pkl", "wb"))
...
plt.savefig('../UXviews/1machLearn/B1.png')
plt.show()
...
plt.savefig('../UXviews/1machLearn/B2.png')
plt.show()
print("======================================|Three_Plots|=====================================8============")
...
plt.savefig('../UXviews/1machLearn/B3.png')
plt.show()
...
plt.savefig('../UXviews/1machLearn/B4.png')
plt.show()
...
plt.savefig('../UXviews/1machLearn/B5.png')
plt.show()
