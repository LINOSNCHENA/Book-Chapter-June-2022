...
plot_model(model, to_file='../UXViews/others/881B.png',  show_shapes=True, show_layer_names=True)
del model
print("\n ===========================================|Parameter|==============================3===========")
...
plt.savefig('../UXviews/others/81B1.png')
plt.show()
...
plt.savefig('../UXviews/others/81B2.png')
plt.show()
...
plt.savefig('../UXviews/others/81B3.png')
plt.show()
