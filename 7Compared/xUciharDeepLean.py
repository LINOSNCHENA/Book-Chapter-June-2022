...
datasetName = './../5dataXYZ/Ucihar3.csv'
...
plot_model(model, to_file='../UXViews/others/881C.png', show_shapes=True, show_layer_names=True)
del model
print("\n ===========================================|Parameter|==============================3===========")
...
plt.title('81.C2-Sisfall_MobiAct | Model-Loss-2.2', fontsize=fontSized)
...
plt.savefig('../UXviews/81C2.png')
plt.savefig('../UXviews/others/81C2.png')
plt.show()
...
plt.title('81.C3-Sisfall_MobiAct | Model-Error-2.3', fontsize=fontSized)
...
plt.savefig('../UXviews/81C3.png')
plt.savefig('../UXviews/others/81C3.png')
plt.show()
...
print("\n ===============|1_SISFALL_successfully_Completed|====================|ONE|===========|CCC|==============")
