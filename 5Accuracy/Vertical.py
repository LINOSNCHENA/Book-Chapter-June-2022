...
# Our data
dataframe = pd.read_csv('./../5dataXYZ/YSis1FallS.csv', header=0, delimiter=",")
...
dataframe = pd.read_csv('./../5dataXYZ/XMobiACT7.csv', header=1, delimiter=",")
...
dataframe = pd.read_csv('./../5dataxyz/ucihart2.csv', header=1, delimiter=",")
print(dataframe.shape)
l = -1*len(dataframe.columns)
print(l)
print(dataframe.head(4))
