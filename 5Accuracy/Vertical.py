...
# Our data
dataframe = pd.read_csv('./../6dataXYZ/YSis1FallS.csv',
                        header=0, delimiter=",")
...
dataframe = pd.read_csv('./../6dataxyz/ucihart2.csv', header=1, delimiter=",")
print(dataframe.shape)
l = -1*len(dataframe.columns)
print(l)
print(dataframe.head(4))
...
print("=================================|S1_S1_SUCCESSFULLY_COMPLETED|==============|Vertical|=================")
