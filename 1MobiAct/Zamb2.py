...
plt.legend(['train1,         : %'+str(accArray1),    'validation1, : %'+str(accArray12)], loc='best', fontsize=size,)
plt.savefig('../UXviews/8B1.png')
plt.savefig('../UXviews/EIGHT/8B1.png')
plt.show()
...
plt.legend(['train2,        :%'+str(accArray2),  'validation2, : %'+str(accArray22)], loc='best', fontsize=size,)
plt.savefig('../UXviews/8B2.png')
plt.savefig('../UXviews/EIGHT/8B2.png')
plt.show()
...
plt.xlabel('epoch', fontsize=fontSized)
# plt.axis([0, epochs, 0, 0.99])
plt.legend(['train3,         :%'+str(accArray3),   'validation3, : %'+str(accArray32)], loc='best', fontsize=size,)
plt.savefig('../UXviews/8B3.png')
plt.savefig('../UXviews/EIGHT/8B3.png')
plt.show()
...
print("\n ===============|1_MOBIACT_ibeacon_Successfully_Completed|===================|ZAMB_TWO|==============|BBB|==========")
