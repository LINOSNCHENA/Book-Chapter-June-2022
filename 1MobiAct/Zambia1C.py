...
plot_model(model, to_file='../UXViews/EIGHT/881C.png', show_shapes=True, show_layer_names=True)
del model
print("\n ===========================================|Parameter|==============================3===========")
...
plt.savefig('../UXviews/EIGHT/81C1.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/81C2.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/81C3.png')
plt.show()
