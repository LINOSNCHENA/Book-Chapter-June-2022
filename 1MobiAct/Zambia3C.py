...
plt.savefig('../UXviews/EIGHT/83C1.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83C2.png', aspect='auto')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83C3.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83C4.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83C5.png')
plt.show()
...
# plt.savefig('../UXviews/EIGHT/83C6.png')
# plt.show()
