...
# plot_model(model, to_file='../UXViews/EIGHT/883A.png', show_shapes=True, show_layer_names=True)
...
plt.savefig('../UXviews/EIGHT/83A1.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83A2.png')
plt.show()
plt.rc('axes', titlesize=20) 
plt.rc('font', size=15) 
plt.rc('axes', labelsize=12) #fontsize of the x and y labels
...
plt.savefig('../UXviews/EIGHT/83A3.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83A4.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/83A5.png')
plt.show()
...
# plt.savefig('../UXviews/EIGHT/83A6.png')
# plt.show()
