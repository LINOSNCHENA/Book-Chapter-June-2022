...
plot_model(model, to_file='../UXViews/EIGHT/881A.png',
...
plt.savefig('../UXviews/EIGHT/81A1.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/81A2.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/81A3.png')
plt.show()
...
print("\n ===============|1_SISFALL_successfully_Completed|====================|ONE|===========|AAA|==============")
