...
dataset = np.loadtxt('./XYZ/XMobiAct7.csv', delimiter=",")
Y = dataset[:, 0:1]
X = dataset[:, 1:10]
...
plot_model(model, to_file='../UXViews/EIGHT/881B.png',  show_shapes=True, show_layer_names=True)
del model
print("\n ===========================================|Parameter|==============================3===========")
...
plt.plot(history.history['val_acc'], color="olive")
plt.title('81.B1-Sisfall_MobiAct| Model-Accuracy-2.1', fontsize=fontSized)
...
plt.savefig('../UXviews/81B1.png')
plt.savefig('../UXviews/EIGHT/81B1.png')
plt.show()
...
plt.title('8.B2-Sisfall_MobiAct | Model-Loss-2.2', fontsize=fontSized)
...
plt.savefig('../UXviews/81B2.png')
plt.savefig('../UXviews/EIGHT/81B2.png')
plt.show()
...
plt.plot(history.history['val_mse'], color="olive")
plt.title('81.B3-Sisfall_MobiAct | Model-Error-2.3', fontsize=fontSized)
...
plt.savefig('../UXviews/81B3.png')
plt.savefig('../UXviews/EIGHT/81B3.png')
plt.show()
...
print("\n ===============|1_MOBIACT_successfully_Completed|====================|ONE|===========|BBB|==============")
