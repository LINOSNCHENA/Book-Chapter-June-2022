...
plot_model(model, to_file='../UXViews/EIGHT/882B.png', show_shapes=True, show_layer_names=True)
print("=============================================11================================5===============")
...
plt.title('8.B1-Sequential2021_Data | Model-Accuracy-2.1', fontsize=fontSized)
...
plt.savefig('../UXviews/82B1.png')
plt.savefig('../UXviews/EIGHT/82B1.png')
plt.show()
...
plt.title('82.B2-Sequential2021_Data | Model-Loss-2.2', fontsize=fontSized)
...
plt.savefig('../UXviews/82B2.png')
plt.savefig('../UXviews/EIGHT/82B2.png')
plt.show()
...
plt.title('82.B3-Sequential2021_Data | Model-Error-2.3', fontsize=fontSized)
...
plt.savefig('../UXviews/82B3.png')
plt.savefig('../UXviews/EIGHT/82B3.png')
plt.show()
...
print("\n ===============|2_MOBIACT_ibeacon_Successfully_Completed|===================|TWO|==============|BBB|==========")
