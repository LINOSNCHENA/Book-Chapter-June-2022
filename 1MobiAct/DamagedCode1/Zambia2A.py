...
plot_model(model, to_file='../UXViews/EIGHT/882A.png',  show_shapes=True, show_layer_names=True)
print("=============================================11================================4===============")
# later...
...
plt.savefig('../UXviews/EIGHT/82A1.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/82A2.png')
plt.show()
...
plt.savefig('../UXviews/EIGHT/82A3.png')
plt.show()
