...
df4.to_csv(r'./../5dataXYZ/YSis1falls.csv', index=0)
...
df4 = pd.DataFrame(df4)
df4.to_csv(r'./../5dataXYZ/YSis1ADLs.csv', index=0)
...
ax1 = ax.table(cellText=df2.values, colLabels=df2.columns,
               loc='center', colColours=kalas, fontsize=zed)
ax1 = ax.table(cellText=df2.values, colLabels=df2.columns,
               loc='center', fontsize=zed)
...
print(df2.shape)
df2.to_csv(r'./../5dataXYZ/YSis1ALLS.csv', index=0)
...
df4.to_csv(r'./../5dataXYZ/YSisFall31S1.csv', header=0, index=0)

df6 = df10.iloc[11982:45010:, -15:]  # 22-Records, last-15X headers
df6 = df6.iloc[0:55:, -15:]      # 22-Records, last-15X headers
df6.to_csv(r'./../5dataXYZ/YSisFall32SX.csv', header=0, index=0)
...
df7.to_csv(r'./../5dataXYZ/YSisFall33SZ.csv', header=0, index=0)


print('=================================|SISFALL_REMOVE_HEADERS|===============================|8|=============')

df10.to_csv(r'./../5dataXYZ/YSis1ALLS.csv', header=0, index=0)
print(df7.head(5))
