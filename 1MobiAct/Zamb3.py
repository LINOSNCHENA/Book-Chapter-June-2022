...
plt.savefig('../UXviews/8C1.png')
plt.savefig('../UXviews/EIGHT/8C1.png')
plt.show()
...
plt.savefig('../UXviews/8C2.png')
plt.savefig('../UXviews/EIGHT/8C2.png')
plt.show()
...
plt.savefig('../UXviews/8C3.png')
plt.savefig('../UXviews/EIGHT/8C3.png')
plt.show()
...
print("\n ===============|3_UCHIHAR2_ibeacon_Successfully_Completed|===================|ZAMB_THREE|==============|CCC|==========")
