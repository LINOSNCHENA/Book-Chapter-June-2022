...
df.index = ['LR Accuracy', 'LDA Accuracy', 'KNN Accuracy','DTC Accuracy', 'ND Accuracy', 'SVM Accuracy', 'RF Accuracy', 'XG Accuracy']
df.index = ['LogRegression Accuracy', 'LDAnalysis Accuracy', 'KNNeighbour Accuracy','DTClassifier Accuracy', 'GNBayes Accuracy', 'SVMachine Accuracy', 'RandomForest Accuracy', 'XGBoost Accuracy']
df.reset_index(inplace = True)
...
df2 = df5
df2.index = ['ALGORITHM USED', 'LR Accuracy', 'LDA Accuracy', 'KNN Accuracy','DTC Accuracy', 'ND Accuracy', 'SVM Accuracy', 'RF Accuracy', 'XG Accuracy']
df2.index = ['ALGORITHM USED','LogRegression Accuracy', 'LDAnalysis Accuracy', 'KNNeighbour Accuracy','DTClassifier Accuracy', 'GNBayes Accuracy', 'SVMachine Accuracy', 'RandomForest Accuracy', 'XGBoost Accuracy']
