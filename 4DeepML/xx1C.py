...
plot_model(model, to_file='../UXViews/image4/31A.png',
...
plt.savefig('../UXviews/image4/31b.png')
plt.show()
...
plt.savefig('../UXviews/image4/31c.png')
plt.show()
...
plt.savefig('../UXviews/image4/31d.png')
plt.show()
...
print("\n ===============|2_UCIHAR_Successfully_Completed|===================|THIRDXX1|==============|CCC|==========")
