...
plot_model(model, to_file='../UXViews/image4/882A.png',  show_shapes=True, show_layer_names=True)
print("=============================================11================================4===============")
print(model.metrics_names)
...
plt.title('82.A1-Sequential2021_Data | Model-Accuracy-2.1', fontsize=fontSized)
...
plt.savefig('../UXviews/image4/82A1.png')
plt.show()
...
plt.savefig('../UXviews/image4/82A2.png')
plt.show()
...
plt.title('82.A3-Sequential2021_Data | Model-Error-2.3', fontsize=fontSized)
...
plt.savefig('../UXviews/image4/82A3.png')
plt.show()
...
print("\n ===============|2_MOBIACT_ibeacon_Successfully_Completed|===================|TWO|==============|AAA|==========")
