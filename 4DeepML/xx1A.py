...
plot_model(model, to_file='../UXViews/image4/11A.png',
...
plt.savefig('../UXviews/image4/11b.png')
plt.show()
...
plt.savefig('../UXviews/image4/11c.png')
plt.show()
...
plt.savefig('../UXviews/image4/11d.png')
plt.show()
...
print("\n ===============|2_SISFALL_Successfully_Completed|===================|firstXX1|==============|AAA|==========")
