...
plot_model(model, to_file='../UXViews/image4/A1.png',
...
plt.savefig('../UXviews/image4/A2.png')
plt.show()
...
plt.savefig('../UXviews/image4/A3.png')
plt.show()
...
plt.savefig('../UXviews/image4/A4.png')
plt.show()
...
print("\n ===============|2_SISFALL_Successfully_Completed|===================|DEEP-LEARNING|=====================")
