...
plot_model(model, to_file='../UXViews/2deepLearn/C1.png',#title="1-MODEL DESIGN AND IMPLEMENTATION-UCIHAR",
...
plt.savefig('../UXviews/2deepLearn/C2.png')
plt.show()
...
plt.savefig('../UXviews/2deepLearn/C3.png')
plt.show()
...
plt.savefig('../UXviews/2deepLearn/C4.png')
plt.show()
