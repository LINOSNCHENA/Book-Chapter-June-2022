...
dataset = np.loadtxt('./../7Data/ucihar3.csv', delimiter=",")
Y = dataset[:, 0:1]
X = dataset[:, 0:10]
print(X.shape)
print(Y.shape)
...
plot_model(model, to_file='../UXViews/2deepLearn/D31.png',#title="1-MODEL DESIGN AND IMPLEMENTATION-UCIHAR",
...
plt.savefig('../UXviews/D32.png')
plt.savefig('../UXviews/2deepLearn/D32.png')
plt.show()
...
plt.savefig('../UXviews/D33.png')
plt.savefig('../UXviews/2deepLearn/D33.png')
plt.show()
...
plt.savefig('../UXviews/D34.png')
plt.savefig('../UXviews/2deepLearn/D34.png')
plt.show()
...
print("\n ===============|2_UCIHAR_Successfully_Completed|===================|DEEP-LEARNING|====================")
